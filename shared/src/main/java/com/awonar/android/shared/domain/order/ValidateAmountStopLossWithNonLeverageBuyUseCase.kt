...
class ValidateAmountStopLossWithNonLeverageBuyUseCase @Inject constructor(
    ...
    override suspend fun execute(parameters: ValidateStopLossRequest): Price {
        ...
        val maxAmountSL =
            -(parameters.stopLoss.amount.times(tradingData.maxStopLossPercentageNonLeveragedBuy)
                .div(100))
